      ...
      <Box sx={{ width: "90%", margin: "auto" }}>
        <Paper sx={{ padding: "4px", textIndent: "40px" }}>
          <Typography variant="body1" color={"text.primary"}>
            ...
            expectation of privacy in their telephone conversations. This has
            been upheld to extend past telephone conversations, now it is
          ...
          <Typography variant="body1" color={"text.primary"}>
            ...
            have positives as is seen here, it also highlights the comprehensive
            surveillance on persons actions, both actual and potential. This
            raises privacy concerns regarding modern data collection and
            surveillance practices. The idea that decisions in your future
            and/or in alternative universes impact you are beyond our current
          ...
          <Typography variant="body1" color={"text.primary"}>
            ...
            technologies that intrude into personal privacy and autonomy.
          </Typography>
        </Paper>
      </Box>
    </>
